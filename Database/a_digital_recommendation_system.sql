...
--
-- Host: localhost
-- Generation Time: Jan 03, 2025 at 01:22 PM
...
--
-- Database: `a_digital_recommendation_system`
--
CREATE DATABASE IF NOT EXISTS `a_digital_recommendation_system` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `a_digital_recommendation_system`;
...
('98ez2737qqth0z49rottr6tf3vwzadwc', 'eyJ1c2VyaWQiOjN9:1slTcW:FWYaHZ-oS7y-krRiwUUcbPKjnMYrGa21P4Jo-npol3M', '2024-09-17 13:30:56.285786'),
...
('kppn44bup8si63bijq9t4d9am3pqk41c', 'eyJ1c2VyaWQiOjR9:1slU7i:savsIR9PE2xyX6gi3TvKS2JxEv7jjINjC_EBKFHRjA0', '2024-09-17 14:03:10.099282'),
...
(3, 'Gokul', 'Gokul123@gmail.com', 'Gokul', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8292,4th Cross,Rajajinagar', 'Male'),
...
(88, 'Artificial Neural Network (ANN)', '53.214285714285715'),
(89, 'SVM', '52.142857142857146'),
(90, 'Logistic Regression', '52.142857142857146'),
(91, 'KNeighborsClassifier', '47.85714285714286'),
(92, 'Decision Tree Classifier', '50.357142857142854'),
(93, 'SGD Classifier', '49.28571428571429'),
(94, 'SVM', '50.0'),
(95, 'Decision Tree Classifier', '47.5');
...
(24, 'Recommended', '50.0'),
(25, 'Not Recommended', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_detect_digital_recommendation`
--

CREATE TABLE IF NOT EXISTS `remote_user_detect_digital_recommendation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `Gender` varchar(300) NOT NULL,
  `Age` varchar(300) NOT NULL,
  `Digital_Material` varchar(300) NOT NULL,
  `Author` varchar(300) NOT NULL,
  `Latitude` varchar(300) NOT NULL,
  `Longitude` varchar(300) NOT NULL,
  `Used_Device` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_detect_digital_recommendation`
--

INSERT INTO `remote_user_detect_digital_recommendation` (`id`, `Fid`, `Gender`, `Age`, `Digital_Material`, `Author`, `Latitude`, `Longitude`, `Used_Device`, `Education_Level`, `Prediction`) VALUES
(1, '[''192.229.163.180-10.42.0.211-443-44480-6'']', 'Female', '21', 'Moby Dick', 'Herman Melville', '48.95258061', '-109.4466988', 'Mobile', 'University', 'Recommended'),
(2, '[''10.42.0.211-23.194.108.108-54658-443-6'']', 'Female', '17', 'Gulliver''s Travels', 'Jonathan Swift', '48.80258003', '-110.2874491', 'Mobile', 'School', 'Not Recommended'),
(3, '[''10.42.0.211-10.42.0.1-28333-53-17'']', 'Male', '17', 'David Copperfield', 'Charles Dickens', '47.15496454', '-109.6210251', 'Mobile', 'School', 'Recommended'),
(4, '[''10.42.0.211-23.205.27.180-34039-80-6'']', 'Female', '21', 'A Farewell to Arms', 'Ernest Hemingway', '32.85978961', '-96.86369771', 'Mobile', 'University', 'Not Recommended');
