"""a_digital_recommendation_system URL Configuration
...
from a_digital_recommendation_system  import settings
...
urlpatterns = [
    ...
    url(r'^Find_Digital_Recommendation_Type/$', remoteuser.Find_Digital_Recommendation_Type, name="Find_Digital_Recommendation_Type"),
    ...
    url(r'^View_Digital_Recommendation_Type_Ratio/$', serviceprovider.View_Digital_Recommendation_Type_Ratio, name="View_Digital_Recommendation_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Digital_Recommendation_Type/$', serviceprovider.View_Digital_Recommendation_Type, name="View_Digital_Recommendation_Type"),
