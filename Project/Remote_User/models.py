...
class detect_digital_recommendation(models.Model):
    ...
    Used_Device= models.CharField(max_length=3000)
    Education_Level= models.CharField(max_length=3000)
