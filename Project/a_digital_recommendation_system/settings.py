...
ROOT_URLCONF = 'a_digital_recommendation_system.urls'
...
WSGI_APPLICATION = 'a_digital_recommendation_system.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'a_digital_recommendation_system',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
